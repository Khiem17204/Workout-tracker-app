...
A personal project using React and JSON local server to store, update, and delete exercises' details and status. In order to run this, you will need to download nodejs, install react and and install json server.

## How to install and run JSON local server
